...
const DisplayCoordinates: FC<DisplayCoordinatesProps> = ({ map }) => {
  ...
  return (
    <div className="absolute top-30 right-4 z-400 hidden lg:flex flex-col bg-white/80 dark:bg-black/80 p-2 text-sm font-semibold rounded-sm text-black dark:text-gray-200">
